...
class VoiceManager extends Component {
    constructor(props) {
        ...
        this.listaVocesRandom = ['en-gb-x-rjs#male_2-local', 'en-us-x-sfg#female_3-local', 'es-us-x-sfb#male_1-local', "en-us-x-sfg#male_2-local", 'en-gb-x-fis#female_3-local']
    ...
    listenToAudio = () => {
        ...
        Tts.setDefaultVoice("en-IN-language");
